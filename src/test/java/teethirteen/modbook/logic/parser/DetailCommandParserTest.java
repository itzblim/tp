...
public class DetailCommandParserTest {
    ...
    public void parse_emptyArg_throwsParseException() {
        CommandParserTestUtil.assertParseFailure(parser, "    ",
                String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, DetailCommand.MESSAGE_USAGE));
    }

    @Test
    public void parse_missingKeyword_throwsParseException() {
        CommandParserTestUtil.assertParseFailure(parser, "cs",
                String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, DetailCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidModuleCode_throwsParseException() {
        CommandParserTestUtil.assertParseFailure(parser,
                CommandTestUtil.INVALID_MODULE_CODE_DESC, ModuleCode.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_validArgs_returnsDetailCommand() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.VALID_MODULE_CODE_DESC,
                GuiState.LESSONS, expectedDetailCommand);
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.VALID_MODULE_CODE_DESC,
                GuiState.EXAMS, expectedDetailCommand);
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.VALID_MODULE_CODE_DESC,
                GuiState.DETAILS, expectedDetailCommand);
    }
}
