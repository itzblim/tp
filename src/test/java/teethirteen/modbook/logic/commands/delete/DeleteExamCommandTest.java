...
public class DeleteExamCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        DeleteCommand deleteExamCommand =
                new DeleteExamCommand(TypicalIndexes.INDEX_FIRST_EXAM, targetModule.getCode());
    ...
    @Test
    public void equals() {
        DeleteCommand deleteExamFirstCommand =
                new DeleteExamCommand(TypicalIndexes.INDEX_FIRST_EXAM, TypicalModules.CS2103T.getCode());
        DeleteCommand deleteExamSecondCommand =
                new DeleteExamCommand(TypicalIndexes.INDEX_SECOND_EXAM, TypicalModules.CS2103T.getCode());

        // same object -> returns true
        assertEquals(deleteExamFirstCommand, deleteExamFirstCommand);

        // same values -> returns true
        DeleteCommand deleteExamFirstCommandCopy =
                new DeleteExamCommand(TypicalIndexes.INDEX_FIRST_EXAM, TypicalModules.CS2103T.getCode());
