...
public class DeleteLessonCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        DeleteCommand deleteLessonCommand =
                new DeleteLessonCommand(TypicalIndexes.INDEX_FIRST_LESSON, targetModule.getCode());
    ...
    @Test
    public void equals() {
        DeleteCommand deleteLessonFirstCommand =
                new DeleteLessonCommand(TypicalIndexes.INDEX_FIRST_LESSON, TypicalModules.CS2103T.getCode());
        DeleteCommand deleteLessonSecondCommand =
                new DeleteLessonCommand(TypicalIndexes.INDEX_SECOND_LESSON, TypicalModules.CS2103T.getCode());

        // same object -> returns true
        assertEquals(deleteLessonFirstCommand, deleteLessonFirstCommand);

        // same values -> returns true
        DeleteCommand deleteLessonFirstCommandCopy =
                new DeleteLessonCommand(TypicalIndexes.INDEX_FIRST_LESSON, TypicalModules.CS2103T.getCode());
