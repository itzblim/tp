...
import static teethirteen.modbook.commons.core.Messages.MESSAGE_INVALID_MODULE_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        String addCommand = AddCommand.COMMAND_WORD + " mod " + CliSyntax.PREFIX_CODE + CommandTestUtil.VALID_MODULE_CODE;
